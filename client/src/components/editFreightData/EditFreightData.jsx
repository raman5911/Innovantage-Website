	...
	componentDidMount() {
		if (this.props.location.state) {
			...
			this.setState({
				...
				shipmentVolume: userData.shipment_volume,
		...
		if (action === "save") {
			...
			axios
				.post(url, {
					...
					shipmentVolume: this.state.shipmentVolume,
				})
				.then((response) => {
				...
				<div className="outer-div">
					...
					<div className="form-group">
						...
						<select
							name="shipmentVolume"
							id="shipmentVolume"
							value={this.state.shipmentVolume}
							onChange={(e) => this.handleInput(e)}
						>
							<option value="Gross Weight (Kgs)">
								Gross Weight (Kgs)
							</option>
							<option value="No. of Packages">
								No. of Packages
							</option>
							<option value="Total Voume (CBM)">
								Total Voume (CBM)
							</option>
						</select>
					</div>

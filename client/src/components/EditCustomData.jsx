...
class EditCustomData extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        if (this.props.location.state) {
            ...
            this.setState({
                ...
                numOfShip: userData.shipment_per_month,
        ...
        if (action === "save") {
            ...
            axios
                .post(url, {
                    ...
                    numOfShip: this.state.numOfShip
                })
                .then((response) => {
                ...
                <div className="outer-div">
                    ...
                    <div className="inner-div">
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" name="numOfShip" id="num-of-ship" value={this.state.numOfShip} onChange={(e) => this.handleInput(e)} placeholder="Enter number of shipments" />
                        </div>
                    </div>
                </div>
...
export default withRouter(EditCustomData);
